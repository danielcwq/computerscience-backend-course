...
let myFunction1 = function () { // notice how the function is not named, but assigned to a variable
...
mySquareFunction = x => { //mySquareFunction is basically declared OUTSIDE and then u can pass a function into another function
    return x**2
}
